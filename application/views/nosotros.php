...
<body id="page-top">
  ...
  <!-- Header -->
  <header class="masthead" id="home" style="background-image: url('../img/bannernosotro.png');">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">¿Quiénes somos?</div>
      ...
      <div class="row section1">
        <div class="col-md-12 mt-3">
            <div class="row mt-4">
                ...
                <div class="col-12 col-sm-7" style="margin: 5px;">
                    <h4 class="service-heading">¿Qué es S.O.S CICLISTA?</h4>
                    <p class="text-muted">
                        S.o.s ciclista es una aplicación desarrollada por BICICLETAS ROBADAS Y AUXILIO VIAL
                        equipo conformado por personas interesadas en la accesibilidad de la información a ciclistas
                        y que se preocupan por ofrecer diferentes herramientas que ayuden a la comunidad a rodar con
                        tranquilidad, seguridad y prevenir incidentes de robo ofreciendo tips y orientación para una mejora
                        de seguridad personal y comunitaria.
                    </p>
                   
                    <h4 class="service-heading">Misión</h4>
                    <p class="text-muted">
                        Nuestra misión es informar a la #comunidadciclista de todo lo que debe tener en cuenta al rodar en 
                        esta ciudad. Estar informado es la herramienta principal que cada ciclista debe aprender, ya que es el 
                        pilar de un buen desarrollo en ésta movilidad emergente llamada ciclismo urbano.    
                    </p>
                </div>
            </div>
        </div>
