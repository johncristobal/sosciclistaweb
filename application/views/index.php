...
<head>
  ...
  <meta name="description" content="SOS Ciclista - Bicicletas robadas y auxilio vial pone a tu
                    disposición todas las herramientas de prevención, seguridad
                    y desplazamiento en una app, para que viajes 
                    tranquilo por toda la ciudad.">
  <meta name="author" content="SOS Ciclista">
  <link rel="shortcut icon" type="image/png" href="<?= base_url()?>img/icono.png"/>

  <title>SOS Ciclista</title>
...
<body id="page-top">
  ...
  <section class="custom" id="services">
    <div class="">
      ...
      <div class="row section1">
        <div class="col-md-6 mt-sm-5">
            <div class="row mt-5 textcenter">
                ...
                <div class="col-12 col-sm-8">
                    <h4 class="service-heading">¡S.O.S CICLISTA!</h4>
                    <p class="text-muted">
                    Bicicletas robadas y auxilio vial pone a tu
                    disposición todas las herramientas de prevención, seguridad
                    y desplazamiento en una app, para que viajes 
                    tranquilo por toda la ciudad. 
                    </p>
        ...
        <div class="d-none d-sm-block col-md-6 no-padding">
  ...
  <section class="customWhite">
    <div class="">
      ...
      <div class="row section1">        
        <div class="col-md-6 no-padding d-none d-sm-block">
            <img class="sectionImage" src="<?= base_url()?>img/banner2.png" >
        </div>
        <div class="col-md-6 mt-5 backbike">
            <div class="row mt-5">
                <div class="col-9 offset-2">
                    <h4 class="service-heading">TODO EN UNA APP</h4>
                    <p class="text-muted">
                    REPORTES DE ROBO, números de serie de bicicletas,
                    mapa de talleres bici-mecánicos de la ciudad,
                    tips y mucho más.
                    </p>
                </div>
            </div>
        ...
        <div class="col-md-6 mt-5">
            <div class="row mt-5">
                <div class=" offset-2 col-9">
                    <h4 class="service-heading">AYUDA AL CICLISTA</h4>
                    <p class="text-muted">
                    Si necesitas ayuda pídelo directamente a un 
                    ciclista que ande cerca de donde estás.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6 no-padding d-none d-sm-block">
            <img class="sectionImage" src="<?= base_url()?>img/banner3.png" >
        </div>
      </div>
    </div>
  </section>
